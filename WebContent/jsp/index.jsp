			...
			<header class="codrops-header">
				<div class="codrops-top clearfix" style="font-size: 15px;">
					...
					<a class="codrops-icon codrops-icon-drop"
						href="/web/billy/shop/startbootstrap-shop-homepage-gh-pages/adminMain.jsp"
						id="Admin"><span>AdminPage</span></a>
						
						<a
						class="codrops-icon codrops-icon-drop" href="logoutProcess.jsp" id="login"><span><%=id%>님
								LogOut</span></a>
					</span>
					<% }else if(id!=null && !id.equals("admin")){ %>
					<span class="right"> 
					<a	class="codrops-icon codrops-icon-drop"
						href="/web/billy/shop/startbootstrap-shop-homepage-gh-pages/myPageMain.jsp"
						id="user"><span>MyPage</span></a>
						
						<a
						class="codrops-icon codrops-icon-drop" href="logoutProcess.jsp" id="LogOut"><span><%=id%>님
								LogOut</span></a>
					</span>
					<% }else{ %>
					<span class="right"> <a
						class="codrops-icon codrops-icon-drop" href="signin.jsp" id="login"><span>
								SignIn</span></a>
								<a
						class="codrops-icon codrops-icon-drop" href="signup.jsp" id="join"><span>
								SignUp</span></a>
					</span>
					<%} %>
					<!--  <span class="right">
